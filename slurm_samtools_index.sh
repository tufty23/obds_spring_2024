...
# convert sam to bam
samtools view -b --with-header -@12 /project/lina3946/1_linux/rnaseq/mapped_reads/sampleERR1755082.sam \
      > /project/lina3946/1_linux/rnaseq/mapped_reads/sampleERR1755082.bam
# sort bam 
samtools sort -@12 /project/lina3946/1_linux/rnaseq/mapped_reads/sampleERR1755082.bam \
      > /project/lina3946/1_linux/rnaseq/mapped_reads/sorted_sampleERR1755082.bam 
# index bam
samtools index -@12 /project/lina3946/1_linux/rnaseq/mapped_reads/sorted_sampleERR1755082.bam
