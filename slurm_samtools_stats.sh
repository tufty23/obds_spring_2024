...
# produce stats
samtools idxstats /project/lina3946/1_linux/rnaseq/mapped_reads/sorted_sampleERR1755082.bam \
      > /project/lina3946/1_linux/rnaseq/mapped_reads/sorted_sampleERR1755082.idxstats

samtools flagstat /project/lina3946/1_linux/rnaseq/mapped_reads/sorted_sampleERR1755082.bam \
      > /project/lina3946/1_linux/rnaseq/mapped_reads/sorted_sampleERR1755082.flagstat
